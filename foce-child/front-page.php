...
?>
    ...
    <main id="primary" class="site-main">
        ...
        <section id="#story" class="story">
            ...
            <article id="place">
                <img class="big-cloud scroll-cloud" src="<?php echo get_stylesheet_directory_uri();?>'/assets/images/big_cloud.png'" alt="Gros Nuage">
                <img class="little-cloud scroll-cloud" src="<?php echo get_stylesheet_directory_uri();?>'/assets/images/little_cloud.png'" alt="Petit Nuage">
                <div>
